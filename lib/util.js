...
//安装devops-app-temp以及他的相关依赖
function getTemplateInstallPackage(template, originalDirectory) {
  let templateToInstall = 'devops-app-temp';
  if (template) {
    if (template.match(/^file:/)) {
      ...
      // Add prefix 'devops-app-temp-' to non-prefixed templates, leaving any
      // @scope/ intact.
...
//get the information of package.json
